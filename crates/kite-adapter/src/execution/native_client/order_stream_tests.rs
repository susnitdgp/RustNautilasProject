...
fn update() -> Message {
    Message::Text(
        r#"{"type":"order","data":{"account_id":"MOCK","order_id":"1","status":"COMPLETE"}}"#
            .into(),
    )
}
...
#[test]
fn websocket_account_id_payload_is_accepted_and_conflicting_identity_is_rejected() {
    for identity in [
        r#""account_id":"MOCK""#,
        r#""user_id":"MOCK""#,
        r#""account_id":"MOCK","user_id":"MOCK""#,
    ] {
        let frame = format!(
    ...
    for identity in [
        r#""account_id":"OTHER""#,
        r#""account_id":"MOCK","user_id":"OTHER""#,
        r#""account_id":"OTHER","user_id":"MOCK""#,
        r#""placed_by":"MOCK""#,
        r#""account_id":null"#,
        r#""account_id":123"#,
    ] {
        ...
        assert!(is_order(&frame, "MOCK").is_err());
    }
}
